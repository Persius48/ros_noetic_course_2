...
bp=[[0.5,0.100],[0.8,0.2],[0.5,-0.2],[0.8,-0.100],[0.15,0.1],[0.5,0.2],[0.15,-0.2],[0.5,-0.1]]
...
def fix_yaw(des_pos):
    ...
    if math.fabs(err_yaw) > yaw_precision_:
        twist_msg.angular.z = 0.28 if err_yaw > 0 else -0.28
