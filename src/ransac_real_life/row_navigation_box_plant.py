...
# parameters
yaw_precision_ = (math.pi / 180)*7 # +/- 2 degree allowed
dist_precision_ = 0.1
# publishers
pub = None
right=[]
...
bp=[[0.5,0.100],[1.0,0.2],[0.5,-0.2],[1.0,-0.100],[0.15,0.1],[0.5,0.2],[0.15,-0.2],[0.5,-0.1]]
...
def fix_yaw(des_pos):
    ...
    #     while math.fabs(err_yaw)> yaw_precision_:
    #         twist_msg.angular.z = 0.7 if err_yaw > 0 else -0.7
    #         pub.publish(twist_msg)
    #         if X_left_1.shape[0]>0 or X_left.shape[0]>0:
    #             break
    #         if X_right_1.shape[0]>0 or X_right.shape[0]>0:
    #             break
        # if X_left_1.shape[0]>0 or X_left.shape[0]>0:
        #     while X_left_1.shape[0]>0 or X_left.shape[0]>0:
        #         twist_msg.angular.z = -0.2 
        #         print('points found on Left_1 at yaw')
        #         pub.publish(twist_msg)
        # if X_right_1.shape[0]>0 or X_right.shape[0]>0:
        #     while X_right_1.shape[0]>0 or X_right.shape[0]>0:
        #         twist_msg.angular.z = 0.2
        #         print('points found on Right_1 at yaw')
        #         pub.publish(twist_msg)
        # change_state(2)
