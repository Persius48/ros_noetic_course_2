...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if not active_:
                ...
                continue
        for i in range(3):
            start_time_inner_for_loop=time.time()
            print('active')
            ...
            if i==2 :
                ...
                desired_position.x = right_x_lower_limit+0.3
            ...
            while not rospy.is_shutdown():
                start_time_inner_while_loop= time.time()
                if state_ == 0:
                ...
                rate.sleep()
                end_time_inner_while_loop=time.time()
                exec_time_inner_while=end_time_inner_while_loop-start_time_inner_while_loop
                print("exec time inner while: ",exec_time_inner_while)
                
            rate.sleep()
            end_time_inner_for_loop=time.time()
            exec_time_inner_for=end_time_inner_for_loop-start_time_inner_for_loop
            print("exec time inner for: ",exec_time_inner_for)
            
        # rospy.loginfo("for loop exit successful")
        while active_:
            start_time_inner_2nd_while_loop=time.time()
            avoid_obstacle()
            rate.sleep()
            end_time_inner_2nd_while_loop=time.time()
            exec_time_inner_2nd_while=end_time_inner_2nd_while_loop-start_time_inner_2nd_while_loop
            print("exec time inner 2nd while: ",exec_time_inner_2nd_while)
        rate.sleep()
        end_time_outer_loop= time.time()
        exec_time_outer=end_time_outer_loop-start_time_outer_loop
        print("exec time outer loop: ", exec_time_outer)
    # rospy.spin()
